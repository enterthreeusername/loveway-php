...
<div class="mdui-card mdui-hoverable" style="border-radius: 16px">
    ...
    <div class="mdui-card-content">
        <div class="mdui-textfield">
            <label class="mdui-textfield-label">你的QQ（我们不会公开显示此选项）</label>
            <textarea id="qq" class="mdui-textfield-input" placeholder="5位以上数字（自动从该qq获取头像）"></textarea>
        </div>
        <div class="mdui-textfield">
            <label class="mdui-textfield-label">你的名字</label>
            <textarea id="name" class="mdui-textfield-input" placeholder="可用昵称"></textarea>
        </div>
        <div class="mdui-textfield">
            <label class="mdui-textfield-label">TA的名字</label>
            <textarea id="taName" class="mdui-textfield-input" placeholder="可用昵称"></textarea>
        </div>
        <div class="mdui-textfield">
            ...
            ?>
                <div class="mdui-row">
                    <div class="mdui-col-md-10 mdui-col-sm-10 mdui-col-xs-7">
                        <textarea id="image" class="mdui-textfield-input" placeholder="本地上传或图片链接"></textarea>
                    </div>
            ...
            ?>
                <textarea id="image" class="mdui-textfield-input" placeholder="https://www.baidu.com/bp.png"></textarea>
            <?php
            }
            ?>
        </div>
        <div class="mdui-textfield">
            ...
            <textarea id="introduceTA" class="mdui-textfield-input" placeholder="他是一个好人"></textarea>
        </div>
        <div class="mdui-textfield">
            <label class="mdui-textfield-label">你想要对TA说的话</label>
            <textarea id="toTA" class="mdui-textfield-input" rows="4" placeholder="我是你爹"></textarea>
        </div>
    </div>
    ...
    <script>
        ...
        $("#upload").on("change", "input[type='file']", function() {
            ...
            if (allow_ext.indexOf(ext) == -1) {
                mdui.alert("上传失败，图片格式不支持，本站仅支持jpg、png、jpeg格式的图片！")
                return false
            }
